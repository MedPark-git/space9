...
def register():
    ...
    app.view_functions["dashboard"]=phase2_dashboard;app.view_functions["financial_transactions"]=financial_transactions_phase2;app.view_functions["financial_transactions_csv"]=finan